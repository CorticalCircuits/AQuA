%% Filtering out small events for the soma ratio
function ratio = FilterareaCompare(res , whichevt , savePath , saveName)
...
if ~oneEvent
    significantEvents = all([areacovered>90;res.fts.basic.area<50;somacovered>=1;res.fts.basic.area>10]);
    ratio = sum(significantEvents)/sum(all([res.fts.basic.area<50;somacovered>=1;res.fts.basic.area>10]));
end
