function [coveredSomaArea,insideSomaArea] = areaCompare(res , bd0 , whichevt , savePath , saveName)
...
if oneEvent
    ...
    hold off
    title('Colorbar Represents Portion of Event inside Soma');
    xlabel('Size of Event (\mum^2)');
    ylabel('%Area of Soma Covered');
    ylim([0 102]);
    colorbar(ax);
