...
imageSavePath = 'C:\Users\coter027\Documents\AQUA Parameter Comparisons figures\Batch V3.0'; %Path to save images generated by hotSpot
...
for evtNumber = 1:length(T(n).res.evt)
evtXYpix = T(n).res.fts.loc.x2D{evtNumber};
evtMap(evtXYpix) = 1;
...
title(['Heat Map of Cell Parameter:' num2str(n)]);
