...
%landmarkFile = 'Z:\Student Access\AQuA Data\Processed Data\ITtest\Cell 8\Landmark\Cell'; %Path and File Name of Landmark MAT File
%load(landmarkFile);
imageSavePath = 'C:\Users\coter027\Documents\AQUA Parameter Comparisons figures\OriginalBatch'; %Path to save images generated by hotSpot
...
if strcmp(SmallEventHistogram , 'on') %Plot Event Raster function initiation
    ...
    fprintf('Small Event Histogram not Selected\n');
end
