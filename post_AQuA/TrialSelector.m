...
plotVector = 1:8; %Plots on EvntRaster that will be processed (Go in code to see which each of 8 plot contains)
landmarkFile = 'X:\AQuA Data\Raw Data\Original Stacks\Landmarks_Batch\cell4_LandMark.mat'; %Path and File Name of Landmark MAT File
load(landmarkFile);
imageSavePath = 'C:\Users\carlo\Research\Images processed'; %Path to save images generated by hotSpot
